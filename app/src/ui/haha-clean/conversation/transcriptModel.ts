...
export const CLEAN_TRANSCRIPT_CAPABILITIES: CleanTranscriptCapability[] = [
  ...
  { kind: "computer_use_permission", label: "Computer Use 权限", current: "backend_needed", source: "missing computer_use_permission_request payload" },
  { kind: "ask_user_question", label: "向用户提问", current: "backend_needed", source: "missing ask_user_question payload" },
