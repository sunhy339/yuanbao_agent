...
1. Product acceptance phase 2 follow-up: optional evidence executors when the product-surface/completion advisors request them, covering different domains rather than a fixed task taxonomy.
