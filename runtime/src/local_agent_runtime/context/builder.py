...
class ContextBuilder(HistoryMixin):
    ...
    def _safety_prompt(self, *, workspace_root: str) -> str:
        return "\n".join([
            ...
            "- inspect workspace context with list_dir, search_files/code_search, and read_file; do not use run_command or ad-hoc Python just to list, search, or read files.",
