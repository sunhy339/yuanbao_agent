"""Message Flow Mixin — extracted from Orchestrator.

Handles the full message lifecycle: routing, planning, execution strategies
(background, supervisor, swarm, DAG), and background worker management.
"""
...
class MessageFlowMixin:
    """Mixin providing message routing and execution strategies."""
